albu_train_transforms = [
    dict(p=0.5, type='RandomBrightnessContrast'),
    dict(p=0.2, type='MotionBlur'),
...
default_hooks = dict(
    checkpoint=dict(
        ...
        rule='greater',
        save_best=
        'NuScenes metric/pred_instances_3d_NuScenes/guilder_AP_dist_0.5',
        type='CheckpointHook'),
...
test_evaluator = dict(
    ann_file=
    '/home/alan_khang/Desktop/adam_dataset/nuscenes_format/guilder_infos_val.pkl',
    backend_args=None,
    data_root='/home/alan_khang/Desktop/adam_dataset',
    metric='bbox',
    type='NuScenesMetric')
...
work_dir = './work_dirs/fcos3d_regnet_adam'
