...
data_root = '/home/alan_khang/Downloads/guilder_dataset'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='guilder_infos_train.pkl',
        backend_args=None,
        box_type_3d='Camera',
        data_prefix=dict(CAM_FRONT='images', pts=''),
        data_root='/home/alan_khang/Downloads/guilder_dataset',
...
test_evaluator = dict(
    ann_file=
    '/home/alan_khang/Downloads/guilder_dataset/guilder_infos_train.pkl',
    backend_args=None,
    data_root='/home/alan_khang/Downloads/guilder_dataset',
    metric='bbox',
    type='NuScenesMetric')
...
train_cfg = dict(max_epochs=36, type='EpochBasedTrainLoop', val_interval=10)
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(flip_ratio_bev_horizontal=0.0, type='RandomFlip3D'),
            dict(
                keys=[
                    'img',
                    'gt_bboxes',
...
work_dir = './work_dirs/fcos3d_adam'
